...
export default function AdminReportsPage() {
  ...
  return (
    <div className="p-6 lg:p-10">
      <h1 className="text-xl font-semibold text-[#171717]">Reports & Exports</h1>
      <p className="mt-1 text-sm text-[#737373]">Generate reports and manage alumni transitions.</p>
        ...
        <div className="rounded-xl border border-[#E5E5E5] bg-white p-6">
          ...
          <div className="mt-4 space-y-2">
            {beneficiaries
              ...
              .slice(0, 10)
              .map((b) => (
                <div key={b._id} className="flex items-center justify-between rounded-lg border border-[#F0F0F0] px-3 py-2">
                  <div>
                    <p className="text-sm text-[#171717]">{b.firstName && b.lastName ? `${b.firstName} ${b.lastName}` : b.user?.name || "Unnamed"}</p>
